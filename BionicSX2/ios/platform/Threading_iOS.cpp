...
// AUDIT REFERENCE: Section 5.3 (POSIX threads, Mach semaphores)
// STATUS: GREEN — Mach semaphores and pthreads are identical on macOS and iOS
...
// Mach primitives — identical on iOS (Audit Section 5.3)
#include <mach/mach.h>
...
// Audit Section 5.3: All primitives below are identical on macOS and iOS
...
// Audit Section 5.3: Mach semaphores work identically on iOS
...
{
    // Audit Section 5.3: pthread_setname_np is available on iOS
